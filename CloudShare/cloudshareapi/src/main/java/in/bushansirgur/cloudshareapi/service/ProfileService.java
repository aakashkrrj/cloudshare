...
public class ProfileService {
    ...
    public ProfileDocument getCurrentProfile() {
        ...
        ProfileDocument existing = profileRepository.findByClerkId(clerkId);
        if (existing != null) {
            return existing;
        }
        // Auto-provision minimal profile for local dev users
        ProfileDocument created = ProfileDocument.builder()
                .clerkId(clerkId)
                .email(null)
                .firstName(null)
                .lastName(null)
